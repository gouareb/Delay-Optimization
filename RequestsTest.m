function [R,RPriority,RrateAllocated,RrateReq,Nr] = RequestsTest(numberOfRequests,npaths,Cnodes,requestedRateRangeA,requestedRateRangeB)
format long
% Description:
...
RrateReq= randi([requestedRateRangeA requestedRateRangeB],1,numberOfRequests);
